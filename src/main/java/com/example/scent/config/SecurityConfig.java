    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        return http.csrf(c -> c.disable()) //tắt csrf protection
                .authorizeHttpRequests(r -> r
                        ...
                        .requestMatchers("/rest/don-hang/getAll","/rest/don-hang/lich-su-thao-tac-by-user/**","/rest/don-hang/huy/**","/rest/don-hang/capnhat-trangthai/**","/rest/don-hang","/rest/don-hang/add","rest/don-hang/update","/rest/don-hang/don-hang/page1","/rest/don-hang/**","rest/don-hang/page","rest/don-hang/del/**").permitAll()
                        ...
                        .requestMatchers("/rest/san-pham/**","/rest/san-pham/detail/**","/rest/san-pham/volums/**","/rest/san-pham/search-price/**","/rest/san-pham/search/**","/rest/san-pham/search-danhmuc/**","rest/san-pham/sorted").permitAll()
