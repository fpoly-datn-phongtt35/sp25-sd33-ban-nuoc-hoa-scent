...
public class donhangDTOID {
    ...
    private Integer trangThai;
        ...
        public donhangDTOID(Integer idTaiKhoan, String tenNguoiNhanHang, String diaChiGiaoHang, String sdtNguoiNhan, String phuongThucVanChuyen, String phuongThucThanhToan, LocalDateTime ngayTao, LocalDateTime ngayVanChuyen, List<OrderItemDTOID> chiTietDonHangs, List<String> imageURL, String ghichu, BigDecimal tongTien, Integer trangThai, BigDecimal phiVanChuyen) {
                this.idTaiKhoan = idTaiKhoan;
                this.tenNguoiNhanHang = tenNguoiNhanHang;
                this.diaChiGiaoHang = diaChiGiaoHang;
                this.sdtNguoiNhan = sdtNguoiNhan;
