...
public class SanPhamInfoDTO2 {
    ...
    private Long tongSoLuongTonKho;
    private LocalDateTime createDate;
    private Long soLuongBan;

    public SanPhamInfoDTO2(Integer idSanPham, String tenSanPham, BigDecimal donGia, String imageURL, String tenThuongHieu, String tenDanhMuc, String moTaHuongDau, String moTaHuongGiua, String moTaHuongCuoi, Integer idnhomHuong, String tennhomHuong, String quocGia, Integer trangThai, Long tongSoLuongTonKho, LocalDateTime createDate, Long soLuongBan) {
        IdSanPham = idSanPham;
    ...
    public Long getTongSoLuongTonKho() {
        return tongSoLuongTonKho;
    }

    public void setTongSoLuongTonKho(Long tongSoLuongTonKho) {
        this.tongSoLuongTonKho = tongSoLuongTonKho;
    }
